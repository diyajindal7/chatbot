...
A user-friendly interface for the FREE RAG system using Hugging Face models
"""
...
def format_response_with_sources(results, question):
    ...
    # For now, we'll show the relevant chunks since we don't have LLM generation
    # In a full implementation, you'd send the prompt to an LLM here
...
def main():
    ...
    # Header
    st.markdown('<h1 class="main-header">🤖 FREE RAG Chatbot</h1>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        # Embedding model selection (for future use)
    ...
    if question:
        ...
        with st.spinner("Searching for relevant information..."):
            ...
            if success and results:
                ...
                response = format_response_with_sources(results, question)
